...
|----------|-----------|---------------|---------------|---------------|--------------|
| database_add_paper | 50 | 2.549 | 0.607 | 46.770 | 6.419 |
| database_list_all | 50 | 4.557 | 3.000 | 8.149 | 0.975 |
| database_search_papers | 50 | 3.381 | 1.961 | 7.010 | 0.928 |
| hybrid_search | 30 | 125.764 | 50.017 | 1739.573 | 305.141 |
| paper_verification | 20 | 2011.149 | 1710.432 | 2355.922 | 154.259 |
| semantic_search | 30 | 108.023 | 40.993 | 1525.964 | 267.927 |

### 4.2 Performance Analysis by Component Category

#### Database Operations

- **database_add_paper**: Average 2.549 ms (Range: 0.607 - 46.770 ms)
- **database_list_all**: Average 4.557 ms (Range: 3.000 - 8.149 ms)
- **database_search_papers**: Average 3.381 ms (Range: 1.961 - 7.010 ms)

#### Search Operations

- **hybrid_search**: Average 125.764 ms (Range: 50.017 - 1739.573 ms)
- **semantic_search**: Average 108.023 ms (Range: 40.993 - 1525.964 ms)

#### Processing

- **paper_verification**: Average 2011.149 ms (Range: 1710.432 - 2355.922 ms)
